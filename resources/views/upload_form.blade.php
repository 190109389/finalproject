...
<div class="container">
<div class="row">
<div class="col-md-8"><h2>Загрузив резюме, вы воспользуетесь возможностью получения фидбэка от нашего эксперта</h2>
</div>
</div>
<br>
<div class="row">
...
<label for="Product Name">ФИО</label>
<input type="text" name="name" class="form-control"  placeholder="ФИО" >
</div>
<label for="Product Name">Резюме</label>
<br />
